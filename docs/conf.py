# -*- coding: utf-8 -*-
#
# sgactions documentation build configuration file, created by
...
htmlhelp_basename = 'sgactionsdoc'
...
latex_documents = [
  ('index', 'sgactions.tex', u'sgactions Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'sgactions', u'sgactions Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'sgactions', u'sgactions Documentation',
   u'Western X', 'sgactions', 'One line description of project.',
   'Miscellaneous'),
]
